...
model {
  ...
  to_vector(drift_con_pr) ~ normal(0, 2.5);
  to_vector(wgt_pun_pr)   ~ normal(0, 2.5);
  to_vector(wgt_rew_pr)   ~ normal(0, 2.5);
  to_vector(update_pr)    ~ normal(0, 2.5);
